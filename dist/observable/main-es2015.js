...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<h3>Yay, I'm home!</h3>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>User with <strong>ID {{ id }}</strong> was loaded</p>\n<button class=\"btn btn-primary\" (click)=\"onActivate()\">Activate!</button>\n");
...
let HomeComponent = class HomeComponent {
    constructor() { }
    ngOnInit() {
        const myNumbers = Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["interval"])(1000)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((data) => {
            return data * 2;
        }));
        this.numbersObsSubscription = myNumbers.subscribe((number) => {
            console.log(number);
        });
        const myObservable = rxjs__WEBPACK_IMPORTED_MODULE_2__["Observable"].create((observer) => {
            setTimeout(() => {
        ...
        this.customObsSubscription = myObservable.subscribe((data) => { console.log(data); }, (error) => { console.log(error); }, () => { console.log('completed'); });
    }
    ngOnDestroy() {
...
module.exports = __webpack_require__(/*! C:\Users\Vova.Evdokimovich\Desktop\observable\src\main.ts */"./src/main.ts");
